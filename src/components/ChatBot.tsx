  ...
  return (
    <>
      <button
        ...
        className={`rounded-tr-5xl fixed right-12 z-[20] transition-all ease-in-out
        ${isOpen ? '-bottom-20 duration-[600ms]' : 'bottom-12 duration-[400ms]'} 
        flex h-14 w-14 cursor-pointer items-center justify-center rounded-tl-full rounded-br-full rounded-bl-full 
        bg-[#12372A] p-[14px] hover:scale-105 hover:bg-[#0F2C22] hover:shadow-lg active:scale-95`}
